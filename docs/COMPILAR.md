...
Este repositório contém o código do LZ Games 1.5.0, os testes e os scripts de empacotamento. Os executáveis e os instaladores não são versionados. Para gerar tudo pelo GitHub Actions, consulte [RELEASE.md](RELEASE.md). Este guia descreve os comandos de compilação local do aplicativo, que recebem dependências já preparadas e não as baixam automaticamente.
...
├── LZGames-Aparador-1.5.0-Setup.exe
├── LZGames-Aparador-1.5.0-TESTE-Setup.exe  # Somente com -IncludeTestBuild
