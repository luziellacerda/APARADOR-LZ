...
**Release `v1.5.0` aprovada e publicada em 25/09/2026:** [execução 36154649490](https://github.com/luziellacerda/APARADOR-LZ/actions/runs/36154649490), commit `828a4aa708a09171bda4b7c208338483c80d18fa`. Passaram **1.309 verificações de interface, 142 de mídia, 133 do instalador e 14 do autoteste**. A bateria de interface inclui resumo compacto, animações e 65 comparações de repintura parcial. O [manifesto da 1.5.0](https://github.com/luziellacerda/APARADOR-LZ/releases/download/v1.5.0/RELEASE-MANIFEST.json) registra hashes e resultados desta compilação. As limitações de captura/manual QA e cobertura de DPI continuam válidas.
