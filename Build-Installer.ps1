...
$installers=foreach($variant in $variants){
    $name=if($variant -eq 1){'LZGames-Aparador-1.4.0-TESTE-Setup.exe'}else{'LZGames-Aparador-1.4.0-Setup.exe'}
