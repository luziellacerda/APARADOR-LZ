...
if ($SelfTest) {
    $selfTestResult=[ordered]@{Version='1.5.0';Passed=$false;TestedUtc=[DateTime]::UtcNow.ToString('o');RuntimeRoot=$script:AppRoot;DataRoot=$script:DataRoot;Mode='Embedded backend and compiled controls; no UI shown';Assertions=@()}
